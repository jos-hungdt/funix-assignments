package com.cry301x.asm3.crypto;
...
public class CryptoUtil {
    ...
    /**
     * TODO: Hash password with the given salt.
    ...
    public static String hashPassword (String password, String salt) {
        ...
        byte[] hashedPasswordBytes = getPasswordKey(password.toCharArray(), saltBytes, PBE_ITERATION);

        return byteArrayToHexString(hashedPasswordBytes);
    }
}
